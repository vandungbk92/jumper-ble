...
import {
  ...
  fetchUsersInfoFailure,
} from "../../epics-reducers/fetch/fetch-users-info.duck";
...
class HomePage extends React.Component {
  static navigationOptions = ({navigation}) => {
    return {
      ...
      headerTitle: () => (
        <RkText rkType="header4">{COMMON_APP.APP_NAME}</RkText>
      ),
  ...
  async componentDidMount() {
    try {
      ...
      if (
        !isEmpty(userToken) &&
        userToken.token !== CONSTANTS.ERROR_AUTHEN
      ) {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (loginRes !== prevProps.loginRes) {
      try {
        if (
          !isEmpty(loginRes) &&
          loginRes.token !== CONSTANTS.ERROR_AUTHEN
        ) {
  ...
  preventBeforeLogin = async (routeName) => {
          ...
          <View style={[tw.flexRow, tw.flexWrap, tw.mT4, tw._m1]}>
            {/*<View style={[tw.p1, tw.w1_3, { minHeight: 120 }]}>
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    this.preventBeforeLogin(UPLOAD_PAGE)
                                }
                            >
            ...
            <View style={[tw.p1, tw.w1_3, {minHeight: 120}]}>
              <TouchableOpacity
                ...
                onPress={() =>
                  this.preventBeforeLogin(PULSEOXIMETER_PAGE)
                }
              >
                <DonThuocIcon style={tw.absolute}/>
                <RkText style={[tw.p4, tw.textLg]}>SpO2</RkText>
              </TouchableOpacity>
            </View>
            <View style={[tw.p1, tw.w1_3, {minHeight: 120}]}>
              <TouchableOpacity
                ...
                onPress={() =>
                  this.preventBeforeLogin(EKO_PAGE)
                }
              >
                <HoiBacSiIcon style={tw.absolute}/>
                <RkText style={[tw.p4, tw.textLg]}>Eko</RkText>
              </TouchableOpacity>
            </View>
            <View style={[tw.p1, tw.w1_3, {minHeight: 120}]}>
              <TouchableOpacity
                ...
                onPress={() =>
                  this.preventBeforeLogin(OMRON_PAGE)
                }
              >
            ...
            <View style={[tw.p1, tw.w1_3, {minHeight: 120}]}>
              <TouchableOpacity
                ...
                onPress={() => this.preventBeforeLogin(HISTORY_PAGE)}
              >
            ...
            <View style={[tw.p1, tw.w1_3, {minHeight: 120}]}>
              <TouchableOpacity
                ...
                onPress={() =>
                  this.preventBeforeLogin(SETTINGS_PAGE)
                }
              >
            ...
            <View style={[tw.p1, tw.w1_3, {minHeight: 120}]}>
              <TouchableOpacity
                ...
                onPress={() =>
                  this.preventBeforeLogin(CANHAN_PAGE)
                }
              >
                <KetQuaCanLamSangIcon style={tw.absolute}/>
                <RkText style={[tw.p4, tw.textLg]}>
                  {
                    this.props.userInfoRes?._id ? "Tài khoản" : "Đăng nhập"
                  }
                </RkText>
              </TouchableOpacity>
            </View>
            ...
            <View style={[tw.p1, tw.w1_3, {minHeight: 120}]}>
              ...
              >
                <LichSuKhamIcon style={tw.absolute}/>
                <RkText style={[tw.p4, tw.textLg]}></RkText>
              </TouchableOpacity>
            </View>*/}
          </View>
        </ScrollView>
