...
class RowItem extends Component {
  ...
  render() {
    ...
    return (
      <View>
        {item.display !== CONSTANTS.NONE ? <View
          key={item[uniqueKey]}
          style={{
            flexDirection: 'row',
            flex: 1,
        ...
        >
          ...
          >
            {item.display !== CONSTANTS.NONE ? <RkText
            rkType="primary2"
            ...
            {this._showSubCategoryDropDown() ?
              <View>
                {dropDownToggleIconUpComponent ? dropDownToggleIconUpComponent
                  :
                  <Ionicons name="ios-arrow-up" size={20} color={KittenTheme.colors.disabled}/>
                }
              </View>
              :
              <View>
                {dropDownToggleIconDownComponent ? dropDownToggleIconDownComponent
                  :
                  <Ionicons name="ios-arrow-down" size={20} color={KittenTheme.colors.disabled}/>
                }
              </View>
            }
          </TouchableOpacity>
